...
import raf.draft.dsw.controller.SetElementSize;
...
public class ElementDimensionFrame extends JFrame {
    ...
    public ElementDimensionFrame() throws HeadlessException {
        initialize();
        showel();
        controller();
    }
    ...
    public void initialize() {
        ...
        setTitle("Set element lenght/width");

        width.setText("Lenght: ");
        height.setText("Width: ");
    }
...
//        exitBtn.setBorder(new EmptyBorder(5, 5, 5, 5));
    ...
    void controller() {
        ...
        saveBtn.addMouseListener(new SetElementSize(roomElement, widthField, heightField, this));
    }
